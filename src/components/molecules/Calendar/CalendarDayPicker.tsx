...
export type DayPickerCalendarProps = React.ComponentProps<typeof DayPicker>;
...
const DayPickerCalendar = ({
  ...
  <DayPicker
    ...
    components={{
      IconLeft: () => <HiArrowSmLeft className="w-4 h-4" />,
      IconRight: () => <HiArrowSmRight className="w-4 h-4" />,
    }}
    {...props}
  />
);
DayPickerCalendar.displayName = "Calendar";

export { DayPickerCalendar };
